...
function heroIsLocal(hero) 
  ...
  local heroes = {get_ratchet(), get_clank(), get_qwark()}
  local heroLocal = {is_ratchet_local(), is_clank_local(), is_qwark_local()}
...
local function getAphelionDriverAndPass()
  ...
  local heroType = {HERO.HERO_TYPE_RATCHET, HERO.HERO_TYPE_QWARK, HERO.HERO_TYPE_CLANK}
  local driver = nil 
  local pass = nil
  local i;
  for i = 1, #heroes, 1 do
...
function DoPCHeroFocus(callback, p1_cams, p1_camMoby, p2_cams, p2_camMoby, focusPosArray, heroArray, 
  ...
  local heroTypes = {HERO.HERO_TYPE_RATCHET, HERO.HERO_TYPE_QWARK, HERO.HERO_TYPE_CLANK, HERO.HERO_TYPE_ALPHA_CLANK}
  local heroes = {get_ratchet(), get_qwark(), get_clank()}
  local p1_index = -1
  local p2_index = -1
  local i;
...
local function CreateCompWaveData_DefaultSpawn(curRoundNum)
  ...
  baseInvasions[5] = {
    ...
    count = {1, 1, 1, 1}, 
    boughtBy = {HERO.HERO_TEAM_1, HERO.HERO_TEAM_1, HERO.HERO_TEAM_2, HERO.HERO_TEAM_2},
